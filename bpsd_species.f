...
c
      ...
      private
c
      logical, save :: bpsd_species_init_flag = .TRUE.
      type(bpsd_0ddatax_type), save :: speciesx
c
      contains
c
c-----------------------------------------------------------------------
      subroutine bpsd_species_init
c-----------------------------------------------------------------------
      use bpsd_subs
      implicit none
c
      ...
      speciesx%ndmax=0
c
      bpsd_species_init_flag = .FALSE.
c
      return
      end subroutine bpsd_species_init
c
c-----------------------------------------------------------------------
...
c
      ...
      integer :: ns, nd
c
      if(bpsd_species_init_flag) call bpsd_species_init
c
