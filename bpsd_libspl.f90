...
!              IERR      : ERROR INDICATOR
      ...
      REAL(rkind), DIMENSION(NXMAX), INTENT(INOUT):: FX
      INTEGER,                  INTENT(OUT):: IERR
      REAL(rkind), DIMENSION(4,NXMAX), INTENT(OUT):: U
      INTEGER  :: ID1, ID2, NX
      REAL(rkind)     :: DX, DX1, DX2, DX3, DXM, DXP, T11, T21, T31, T41, &
...
!       **** Calculation of interpolation  ****
      ...
      REAL(rkind),DIMENSION(NXMAX),  INTENT(IN) :: X
      REAL(rkind),DIMENSION(4,NXMAX),INTENT(IN) :: U
...
!     +++++++++++++++++
      ...
      REAL(rkind), DIMENSION(4,NMAX),INTENT(INOUT):: A
      REAL(rkind), DIMENSION(NMAX),  INTENT(INOUT):: X
      INTEGER,                INTENT(OUT)  :: IERR
      REAL(rkind)    :: AAN,BBN,AN,BN,CN,DN,FACT,XN
      INTEGER :: N
...
!     +++++++++++++++++
      ...
      REAL(rkind), DIMENSION(NMAX),  INTENT(INOUT):: X
      INTEGER,                INTENT(OUT)  :: IERR
      REAL(rkind) :: AAN, BBN, CCN, DDN, EEN, DDNN, EENN, AN, BN, CN, DN, FACT, X1, XN
      INTEGER :: N
