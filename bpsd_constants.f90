...
!  real(rkind),parameter :: EPS0 = ONE/(VC*VC*RMU0)   ! permittivity
  ...
  real(rkind),parameter :: AMU  = 1.66053906660E-27_dp! Atomic Unit Mass  [kg]
  ...
  real(rkind),parameter :: AMHe3= 5.0064127796E-27_dp ! helion mass       [kg]
  real(rkind),parameter :: AMA  = 4.001506179127D0*AMU! alpha mass        [kg]
  real(rkind),parameter :: VC   = 2.99792458E8_dp     ! speed of light    [m/s]
  real(rkind),parameter :: RMU0 = 4.E-7_dp*PI         ! permeability      [H/m]
  real(rkind),parameter :: EPS0 = ONE/(VC*VC*RMU0)    ! permittivity
