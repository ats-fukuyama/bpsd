...
30   NFOPEN=1
  ...
  WRITE(26) (RNODE(I),ZNODE(I),KANOD(I),KBNOD(I),I=1,NNMAX)
  WRITE(26) ((NDELM(J,I),KNELM(J,I),NSDELM(J,I),J=1,3),I=1,NEMAX)
  WRITE(26) ((NDSID(J,I),J=1,2),KASID(I),KBSID(I),I=1,NSDMAX)
  WRITE(26) (CESD(I),I=1,NSDMAX)
  WRITE(26) (CEND(I),I=1,NNMAX)
  WRITE(26) ((CBF(J,I),CBP(J,I),J=1,3),I=1,NNMAX)
  WRITE(26) (NSDBS(I),CEBSD(I),I=1,NBSID)
  WRITE(26) (NNDBS(I),CEBND(I),I=1,NBNOD)
  CLOSE(26)
  
  WRITE(6,*) '## wf2d data save in FILE: ',KFNAMF
